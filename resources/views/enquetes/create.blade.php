                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.enquetes.store') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="datetime-local" name="data_inicio" id="data_inicio" class="block mt-1 w-full" required>
                        </div>
                        <div class="mt-4">
                            <label for="data_termino">Data Término</label>
                            <input type="datetime-local" name="data_termino" id="data_termino" class="block mt-1 w-full" required>
                        </div>
                        <div class="mt-4">
                            <label>Opções (Mínimo 3)</label>
                            <div id="opcoes-container">
                                <input type="text" name="opcoes[]" class="block mt-1 w-full mb-2" required>
                                <input type="text" name="opcoes[]" class="block mt-1 w-full mb-2" required>
                                <input type="text" name="opcoes[]" class="block mt-1 w-full mb-2" required>
                            </div>
